<template>
  <div class="bg-gray-50 dark:bg-[#3b3b3b] min-h-dvh py-20">
    <div class="container mx-auto">
      <div class="title flex mb-10">
        <UIcon name="i-heroicons-home" class="text-green-600 text-8xl mr-5" />
        <div>
        ...
        <UIcon dynamic :name="`i-heroicons-${isDark ? 'sun' : 'moon'}`" class="text-green-600 text-4xl ml-auto cursor-pointer" @click="isDark = !isDark" />
      </div>
